...
ActiveRecord::Schema.define(version: 20161030042316) do
  ...
  create_table "cuisines_followed_by_users", force: :cascade do |t|
    t.integer  "cuisine_id", null: false
    t.integer  "user_id",    null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["cuisine_id"], name: "index_cuisines_followed_by_users_on_cuisine_id", using: :btree
    t.index ["user_id"], name: "index_cuisines_followed_by_users_on_user_id", using: :btree
  end
